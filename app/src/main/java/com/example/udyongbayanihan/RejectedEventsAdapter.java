...
class RejectedEventsAdapter extends RecyclerView.Adapter<RejectedEventsAdapter.EventViewHolder> {
    private static final String TAG = "RejectedEventsAdapter";
    private List<EventModel> eventsList;
    private Context context;

    public RejectedEventsAdapter(List<EventModel> eventsList) {
    ...
    public EventViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context)
                .inflate(R.layout.rejected_admin_events, parent, false);
    ...
    class EventViewHolder extends RecyclerView.ViewHolder {
        ...
        public EventViewHolder(View itemView) {
            ...
            imagesRecyclerView = itemView.findViewById(R.id.rejectedImagesRecyclerView);
        }
